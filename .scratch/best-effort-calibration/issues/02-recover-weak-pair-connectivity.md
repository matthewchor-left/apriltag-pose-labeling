...
- [x] Restored weak edges require at least two supporting frames (`_BEST_EFFORT_WEAK_EDGE_MIN_SUPPORT`); the floor counts dominant-consensus inlier frames (`len(edge.inlier_frames)`), not raw observed co-visibility.
